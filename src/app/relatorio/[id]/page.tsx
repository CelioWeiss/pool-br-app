...
import type { Client, Appointment, ServiceLocation, Technician } from '@/lib/types';
...
export default function RelatorioPage() {
  ...
  const technicianDocRef = useMemo(() =>
    (firestore && franchiseId && technicianId) ? doc(firestore, `franchises/${franchiseId}/technicians`, technicianId) : null
  ...
  const renderContent = () => {
    ...
    return (
      <div className="p-4 space-y-6 max-w-6xl mx-auto">
        ...
        <ServiceReportForm appointment={appointment} client={client} location={location} technician={technician} />
      </div>
    );
  }
